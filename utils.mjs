...
export const sleep = (msec, value=msec) => new Promise(resolv => setTimeout(() => resolv(value), msec));
export const mixin = (...mixins) => (function wapper() { const base = function base(){}; return Object.assign(base.prototype, ...mixins);})();
