...
export { AND, All, Any, Either, Fromise, Just, Maybe, NAND, NOR, NOT, Noop, Nothing, OR, XNOR, XOR, __false, __true, arrayfy, attach, chart_dump, curry, hasIn, identity, if_then_else, isFalse, isFalsy, isFunction, isIterable, isNotFalsy, isUndefined, lift, mixin, pipe, Reduce as reduce, revoke, run, sleep, ternary, truth };
